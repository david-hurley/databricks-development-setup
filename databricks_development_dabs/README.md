# databricks_development_dabs

The 'databricks_development_dabs' project was generated by using the default-python template.
...
3. To deploy a development copy of this project, type:
    ...
    `[dev yourname] databricks_development_dabs_job` to your workspace.
...
4. Similarly, to deploy a production copy, type:
   ...
   (defined in resources/databricks_development_dabs.job.yml). The schedule
